...
This set of practice exercises corresponds to the lecture 1 slides and Chapter 1 of the textbook [OpenIntro Statistics](https://openintro.org/book/os/). 

## Exercise 1

### Case Study: using stents to prevent strokes

Watch the video "Case Study: using stents to prevent strokes" included in the lecture slides for lecture 1 and answer the following questions.  
...
Watch the video on Data Basics included in slide 18 of lecture 1. 
...
Watch the video on Data Collection included on slide 21 of lecture 1 slides. 
